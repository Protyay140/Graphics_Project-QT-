...
"background-color: rgb(85, 255, 255);"));
        ...
        draw_background->setGeometry(QRect(710, 480, 281, 51));
        speed = new QSpinBox(centralWidget);
        speed->setObjectName("speed");
        speed->setGeometry(QRect(960, 320, 42, 22));
        speed->setValue(3);
        speed_label = new QLabel(centralWidget);
        speed_label->setObjectName("speed_label");
        speed_label->setGeometry(QRect(950, 340, 51, 20));
        start = new QPushButton(centralWidget);
        start->setObjectName("start");
        start->setGeometry(QRect(740, 570, 80, 18));
        stop = new QPushButton(centralWidget);
        stop->setObjectName("stop");
        stop->setGeometry(QRect(850, 570, 80, 18));
        lineEdit = new QLineEdit(centralWidget);
        lineEdit->setObjectName("lineEdit");
        lineEdit->setGeometry(QRect(720, 600, 113, 20));
        lineEdit_2 = new QLineEdit(centralWidget);
        lineEdit_2->setObjectName("lineEdit_2");
        lineEdit_2->setGeometry(QRect(850, 600, 131, 20));
        speedUp = new QPushButton(centralWidget);
        speedUp->setObjectName("speedUp");
        speedUp->setGeometry(QRect(740, 540, 81, 21));
        speedDown = new QPushButton(centralWidget);
        speedDown->setObjectName("speedDown");
        speedDown->setGeometry(QRect(840, 540, 91, 21));
        lineEdit_3 = new QLineEdit(centralWidget);
        lineEdit_3->setObjectName("lineEdit_3");
        lineEdit_3->setGeometry(QRect(720, 620, 113, 20));
        lineEdit_4 = new QLineEdit(centralWidget);
        lineEdit_4->setObjectName("lineEdit_4");
        lineEdit_4->setGeometry(QRect(850, 620, 131, 20));
